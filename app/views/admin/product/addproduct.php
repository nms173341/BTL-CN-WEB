    ...
    <body>
        ...
        <div class="admin_content">
            ...
            <div class="content">
                ...
                <form action="<?php echo BASE_URL ?>adminproduct/add" method="post" id="product_form">
                    <div class="panel-body">
                        <div class="form-group">
                            <label class="control-label" for="input-name">Product Name</label>
                            <input type="text" name="product_name" value="" placeholder="Product Name" id="input-name" class="form-control" autocomplete="off"><ul class="dropdown-menu"></ul>
                        </div>
                        <div class="form-group">
                            <label class="control-label" for="input-image">Image</label>
                            <input type="file" name="image" value="<?php echo BASE_URL?>" placeholder="image" id="input-model" class="form-control" autocomplete="off"><ul class="dropdown-menu"></ul>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="description" value="" placeholder="Description" id="input-quantity" class="form-control">
                        </div>
                        <div class="form-group">
