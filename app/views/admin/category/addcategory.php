...
<div class="admin_content">
    ...
    <div class="content">
        ...
        <form action="<?php echo BASE_URL?>admincategory/add" method="post">
            <div class="panel-body">
                <div class="form-group">
                    <label class="control-label" for="input-first-name">Category Name</label>
                    <input type="text" name="name" value="" placeholder="Category Name" id="input-category-name" class="form-control" autocomplete="off"><ul class="dropdown-menu"></ul>
                </div>
                <div class="form-group">
                    <label class="control-label" for="input-last-name">Description</label>
                    <input type="text" name="description" value="" placeholder="Description" id="input-description" class="form-control" autocomplete="off"><ul class="dropdown-menu"></ul>
                </div>
                <div class="form-group">
