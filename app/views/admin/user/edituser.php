...
<html lang="en" dir="ltr">
    ...
    <body>
        ...
        <div class="admin_content">
            ...
            <div class="content">
                <h3 class="panel-title">Edit customer <?php echo $data['user'][0]['name']?></h3>
                <form action="<?php echo BASE_URL ?>adminuser/save" id="user_form" method="post">
                    <div class="panel-body">
                        <div class="form-group">
                            <label class="control-label" for="input-first-name">Name</label>
                            <input type="text" name="name" value="<?php echo $data['user'][0]['name']?>" placeholder="Name" id="input-first-name" class="form-control" autocomplete="off"><ul class="dropdown-menu"></ul>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="email" value="<?php echo $data['user'][0]['email']?>" placeholder="Email" id="input-email" class="form-control">
                        </div><br>
                        <div class="form-group">
                            <label class="control-label" for="input-date">Address</label>
                            <input type="text" name="address" value="<?php echo $data['user'][0]['address']?>" placeholder="Address" id="input-date" class="form-control">
                        </div><br>
                        <div class="form-group">
                            <label class="control-label" for="input-telephone">Phone Number</label>
                            <input type="text" name="phone_number" value="<?php echo $data['user'][0]['phone_number']?>" placeholder="Telephone" id="input-telephone" class="form-control">
                        </div><br><br>
                        <input type="hidden" name="user_id" value="<?php echo $data['user'][0]['user_id']?>">
                        <div class="form-group">
