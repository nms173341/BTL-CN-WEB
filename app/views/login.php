...
<head>
    ...
    <script src="<?php echo BASE_URL?>public/js/validateLogin.js"></script>
            ...
            <div class="row">
                ...
                <div class="col-2">
                    <div class="form-container">
                        ...
                        <form id="LoginForm" action="<?php echo BASE_URL?>login/authentication_login" onSubmit="return validateForm()" method="post">
                            <input id="adminUsername" type="text" name="email" placeholder="Email">
